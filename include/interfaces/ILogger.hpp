...
/*   Updated: 2025/04/22 09:05:47 by fmol             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class ILogger
{
  public:
    ...
    virtual void logRequest(const IRequestParser &request) const = 0;
    virtual void logResponse(const IResponse &response) const = 0;
